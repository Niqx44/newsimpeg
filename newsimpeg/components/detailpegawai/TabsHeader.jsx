// components/detailpegawai/TabsHeader.jsx
"use client";

import React from "react";
import { User, Layers, Briefcase, GraduationCap, BookOpen, BarChart3, Medal, BadgeCheck, FolderArchive, TrendingUp } from "lucide-react";
        ...
        return (
          <button
            ...
            className={`flex items-center gap-2 pb-2 text-sm font-medium transition ${
              active ? "text-black border-b-2 border-blue-900" : "text-gray-500 hover:text-gray-700"
            }`}
          >
            <Icon size={14} />
            {t.label}
